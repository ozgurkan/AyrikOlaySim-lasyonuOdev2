...
samples=binomGenerate(noSamples,0.7,40);
samples1=binomGenerate(noSamples,0.5,50);
...
formulaGenerated = binomGenerateFormula(40, 0.7);
formulaGenerated1 = binomGenerateFormula(50, 0.5);
...
legend('n = 40 p = 0.7  MY CREATED  BÝNOMÝAL DÝSTRÝBUTÝON PMF ', 'n = 40 p = 0.7 ANALYTÝCAL RESULTS WÝTH DÝSTRÝBUTÝON FORMULAS ','n = 50 p = 0.5  MY CREATED  BÝNOMÝAL DÝSTRÝBUTÝON PMF ', 'n = 50 p = 0.5 ANALYTÝCAL RESULTS WÝTH DÝSTRÝBUTÝON FORMULAS')
...
legend('n = 40   p = 0.7  MY CREATED  BÝNOMÝAL DÝSTRÝBUTÝON CDF ','n = 50   p = 0.5  MY CREATED  BÝNOMÝAL DÝSTRÝBUTÝON CDF','Location','northwest')
